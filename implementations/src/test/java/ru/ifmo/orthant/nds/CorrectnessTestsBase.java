...
public abstract class CorrectnessTestsBase {
    protected abstract BiFunction<Integer, Integer, NonDominatedSorting> getFactory();
    ...
    public void maximumBoundariesAreSane() {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            NonDominatedSorting s = getFactory().apply(maxPoints, maxDimension);
    ...
    public void doesNotShareState() {
        NonDominatedSorting sorting = getFactory().apply(2, 3);
